...
def draw_bounding_box_on_image_array(image,
  ...
  """
  image_pil = Image.fromarray(np.uint8(image)).convert('RGB')
  draw_bounding_box_on_image(image, image_pil, ymin, xmin, ymax, xmax, color,
...
def draw_bounding_box_on_image(img,
  ...
  cv2.putText(img, "smoking", (50, 100), cv2.FONT_HERSHEY_SIMPLEX, 2, (0,0,255), 2)
  f = open("smoking_log.txt", 'a')
